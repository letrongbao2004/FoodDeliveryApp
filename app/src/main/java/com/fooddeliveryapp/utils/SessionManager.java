...
public class SessionManager {
    ...
    public boolean isMerchant() { return "merchant".equals(getRole()); }

    public void updateName(String name)     { editor.putString(KEY_NAME, name).apply(); }
    public void updatePhone(String phone)   { editor.putString(KEY_PHONE, phone).apply(); }
    public void updateAddress(String addr)  { editor.putString(KEY_ADDRESS, addr).apply(); }

    public void setToken(String token)      { editor.putString(KEY_TOKEN, token).apply(); }
